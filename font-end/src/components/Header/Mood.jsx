...
const  Mood = ()=> {
  ...
  const localStorage_Mood = localStorage.getItem('Mood');
  ...
  const handleMood = ()=>{
    ...
    if(mood === 'ligth'){
      setMood('dark')
         ...
         setMood('ligth')
         localStorage.setItem('Mood' , 'ligth')
       }
  }

  document.body.style.background = `${mood === 'ligth' ? '#f2f2f2' : '#283747 '}`


  return (
    <FormGroup onClick={handleMood} >
      <FormControlLabel
